#!/usr/bin/env python3
"""Unified local HTML dashboard for March Curator progress.
...
def parse_args(argv: list[str]) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate a local HTML dashboard for March Curator progress.")
