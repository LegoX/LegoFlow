---
title: Dashboard
description: Monitor Curator progress online
---
...
[Open Curator Databoard](https://swe-databoard.pages.dev/)
...
From a Claude session in the block, `/curator:dashboard` drives it — local
...
| Project | URL | Purpose |
| --- | --- | --- |
| `swe-curator-docs` | `https://swe-curator-docs.pages.dev` | This documentation site |
| `swe-databoard` | `https://swe-databoard.pages.dev/` | Live Curator progress dashboard |
