...
│   ├── checkpoint-<step>/          #   cadence follows save_strategy
...
`runtime_info.output.checkpoint_path` is the block's primary handoff to downstream consumers (`rl`, `evaluator`). See [Inputs & Outputs](/docs/reference/io) for the full contract.
