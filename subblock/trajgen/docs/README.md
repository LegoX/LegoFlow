...
User-facing documentation for the [trajgen](../README.md) block, built as a
[fumadocs](https://fumadocs.dev/) (Next.js) site and deployed to Cloudflare
Pages as a static export.

Live site: **<https://swe-trajgen-docs.pages.dev>**
...
Builds and deploys `out/` to the `swe-trajgen-docs` Cloudflare Pages project
(published at <https://swe-trajgen-docs.pages.dev>, separate from the
dashboard's `swe-trajgen-databoard`). It activates Node 22
