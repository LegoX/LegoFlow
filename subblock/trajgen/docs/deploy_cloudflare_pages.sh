#!/usr/bin/env bash
# Build the trajgen docs (fumadocs/Next.js static export) and deploy to a
# dedicated Cloudflare Pages project. Independent of the dashboard project
# (swe-trajgen-databoard); this one defaults to swe-trajgen-docs.
#
...
PROJECT_NAME="${PROJECT_NAME:-swe-trajgen-docs}"
...
# otherwise the docs would deploy over swe-trajgen-databoard.
