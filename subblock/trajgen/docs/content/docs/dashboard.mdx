...
When operating through the trajgen plugin, `/trajgen:dashboard` covers both the visual dashboard and one-off SFT data/stat refreshes via `scripts/convert_trajectories.sh`.
