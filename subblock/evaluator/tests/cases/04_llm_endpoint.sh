...
#
# evaluator's upstream (qwen.jierungogogo.com) is a Cloudflare-gated production
...
# Cloudflare-gating / proxy-mediated codes that are not evaluator misconfigurations.
