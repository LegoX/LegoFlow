...
required = {
    ...
    "no_hack prepare": 'bash "$BLOCK_DIR/scripts/prepare_nohack.sh"',
    "no_hack agent allowlist": '--agent-extra-allowed-host',
    "no_hack -100 rejection": '-100 subsets are not supported with no_hack',
