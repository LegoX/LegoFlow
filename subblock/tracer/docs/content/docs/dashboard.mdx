...
tracer ships a self-contained progress dashboard that scans your artifacts and renders a single HTML page — open it locally, or publish it to Cloudflare Pages for remote viewing.
