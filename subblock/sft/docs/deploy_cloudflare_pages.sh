#!/usr/bin/env bash
# Build the sft docs (fumadocs/Next.js static export) and deploy to a dedicated
# Cloudflare Pages project (defaults to swe-sft-docs).
#
...
#
# Reuses the same Cloudflare credentials as the trajgen dashboard sync:
...
PROJECT_NAME="${PROJECT_NAME:-swe-sft-docs}"
