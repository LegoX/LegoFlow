"""
Lightweight API server for the LegoFlow-Trainer training dashboard.
...
def main():
    p = argparse.ArgumentParser(description="LegoFlow-Trainer Training Dashboard Server")
    ...
    print(f"LegoFlow-Trainer Dashboard on http://{args.host}:{args.port}")
