...
```bash
bash blocks/trainer/tests/smoke/prepare_smoke_data.sh   # → $SHARED_RUNTIME/sft/.../lf_512.json
```
...
| 07: `deepspeed config missing` | `scripts/deepspeed/*.json` got deleted | `git restore blocks/trainer/scripts/deepspeed/` |
