...
This page records a concrete run of the profile in `blocks/trainer/config.yaml`. It shows the commands, effective training settings, elapsed time, curves, and files produced so you can estimate the cost of a similar job.
