...
`runtime_info.output.checkpoint_path` is the block's primary handoff to downstream consumers (`evaluator`). See [Output Format](/docs/outputs) for the full contract.
