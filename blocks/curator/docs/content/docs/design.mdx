...
| --- | --- | --- |
| [legoflow-curator](https://github.com/SWE-Lego/legoflow-curator) | `repos/legoflow-curator` | The `legoflow-curator` CLI and its tools: PR collection, task generation through the Claude Code path, NOP/Oracle validation, and difficulty scoring. |
