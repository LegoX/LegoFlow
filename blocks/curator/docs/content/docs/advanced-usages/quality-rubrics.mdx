...
From `blocks/curator/dashboard/`, regenerate task metadata with:
...
The public databoard compares difficulty and tag composition across curated
datasets:

[Open the Databoard](https://swe-databoard.pages.dev/)

The databoard is for finished datasets. During task generation, inspect logs,
