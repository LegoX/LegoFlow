...
| `/curator:dashboard` | Regenerate and publish the dataset analytics databoard: per-task difficulty scores and semantic tags across datasets. Not run-progress monitoring. |
