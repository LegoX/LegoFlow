...
```bash
cd /path/to/LegoFlow/blocks/evaluator/dashboard
...
LOOP_SECONDS="3600"
HARBOR_JOBS_DIR="/path/to/LegoFlow/blocks/evaluator/artifacts/jobs"
...
python3 upload_trajectories_r2.py \
  --jobs-dir /path/to/LegoFlow/blocks/evaluator/artifacts/jobs \
