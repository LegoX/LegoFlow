...
| [swe_data_process](https://github.com/LegoX/swe_data_process) | `repos/swe_data_process` | The trajectory converters. One module per scaffold turns raw rollouts into IM records and then LLaMA-Factory LF data, and computes the TQS quality scores. |
