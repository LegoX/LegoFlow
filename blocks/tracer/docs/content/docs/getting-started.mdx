...
exact pass conditions, see [Test Cases](/docs/test-cases). A healthy report
...
[Trajectory Conversion](/docs/advanced-usages/trajectory-conversion) and [Supported Scaffolds](/docs/advanced-usages/scaffolds).
...
For the internal rollout mechanism, see [Design](/docs/mechanism).
