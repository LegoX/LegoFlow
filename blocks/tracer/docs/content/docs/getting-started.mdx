...
- Claude Code or Codex with the Tracer plugin loaded.
...
| Claude Code | Codex |
| --- | --- |
| `/tracer:setup` | `$tracer-setup` |

This prepares the pinned `repos/harbor` and `repos/LegoFlow-Trace-Crafter` checkouts,
...
| Claude Code | Codex |
| --- | --- |
| `/tracer:dashboard` | `$tracer-dashboard` |
