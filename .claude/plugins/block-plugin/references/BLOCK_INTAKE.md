...
What should the agent display in `dashboard/overview.mdx`? Describe the key metrics, progress indicators, or summaries a human should see at a glance.

```yaml
dashboard: |
  # describe what to show here, e.g.:
  # - progress per language (tasks verified, failed, filtered)
  # - current phase and next steps
  # - links to latest run log
```
