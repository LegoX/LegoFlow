...
Invoke this Codex skill as `$tracer-dashboard`. The shared CLI fallback is `./bin/legoflow /tracer:dashboard` when the agent does not expose slash commands directly.
