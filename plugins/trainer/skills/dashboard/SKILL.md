...
Invoke this Codex skill as `$trainer-dashboard`. The shared CLI fallback is `./bin/legoflow /trainer:dashboard` when the agent does not expose slash commands directly.
