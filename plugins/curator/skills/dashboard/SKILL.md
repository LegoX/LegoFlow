...
Invoke this Codex skill as `$curator-dashboard`. The shared CLI fallback is `./bin/legoflow /curator:dashboard` when the agent does not expose slash commands directly.
