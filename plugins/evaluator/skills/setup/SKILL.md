...
Invoke this Codex skill as `$evaluator-setup`. The shared CLI fallback is `./bin/legoflow /evaluator:setup` when the agent does not expose slash commands directly.
