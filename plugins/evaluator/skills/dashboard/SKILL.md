...
Invoke this Codex skill as `$evaluator-dashboard`. The shared CLI fallback is `./bin/legoflow /evaluator:dashboard` when the agent does not expose slash commands directly.
