...
Invoke this Codex skill as `$evaluator-check`. The shared CLI fallback is `./bin/legoflow /evaluator:check` when the agent does not expose slash commands directly.
