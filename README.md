...
- **Open-source tasks and trajectories**: We release [**LegoFlow-SWE**](https://huggingface.co/datasets/Lego-X/LegoFlow-SWE), containing **5,000 tasks** carefully filtered from 12M PRs and covering 8 programming languages and 20 task tags. We also release **2,780 successful trajectories**. Training `Qwen3.5-35B-A3B-Base` on only 1K samples reaches **48.8% on SWE-bench Pro**.
