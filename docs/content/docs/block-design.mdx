...
A **block** is the unit of work in LegoFlow. Every stage of the pipeline, from data curation, trajectory generation, training, to Evaluator measurement, is a block with a shared shape and a familiar skill lifecycle. This page explains the design behind: what lives inside a block, how blocks pass data to each other, and where runs are recorded. The following figure shows the structure of a block.
