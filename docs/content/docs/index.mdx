...
- **Fully Vibe-coding**: LegoFlow turns repo and PR collection, task verification, trajectory rollout, and the training-evaluation loop into prepared plugin skills. Users can interact with a coding agent, such as Claude Code, to run real data production instead of stitching scripts together by hand.
