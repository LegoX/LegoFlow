...
<div className="docs-tldr">
  <span className="docs-tldr-label">TL;DR</span>
  <span><strong>LegoFlow</strong> makes agent data engineering easy and interactive. It turns task curation, trajectory rollout, training, and evaluation into composable blocks that users can set up, run, inspect, and evolve through guided agent skills.</span>
</div>
...
{/*- We also release `swe-lego-rebench-1k-glm5.2` (<a href="https://huggingface.co/datasets/SWE-Lego/SWE-Lego-Live" className="docs-hf-link"><img src="https://huggingface.co/front/assets/huggingface_logo-noborder.svg" alt="" aria-hidden="true" className="docs-hf-logo" />Hugging Face</a>), a high-quality dataset curated from swe-rebench, that */}
